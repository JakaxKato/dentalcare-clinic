...
export const dentistService = {
  ...
  update: (id, data) =>
    api.put(`/dentists/${id}`, data).then((r) => r.data.data),
...
export const serviceService = {
  list: (activeOnly = false) =>
    api
      .get("/services", { params: activeOnly ? { activeOnly: true } : {} })
      .then((r) => r.data.data),
...
export const appointmentService = {
  ...
  updateStatus: (id, data) =>
    api.put(`/appointments/${id}/status`, data).then((r) => r.data.data),
  reschedule: (id, data) =>
    api.put(`/appointments/${id}/reschedule`, data).then((r) => r.data.data),
...
export const articleService = {
  ...
  update: (id, data) =>
    api.put(`/articles/${id}`, data).then((r) => r.data.data),
...
export const testimonialService = {
  ...
  approve: (id, isApproved = true) =>
    api
      .put(`/testimonials/${id}/approve`, { isApproved })
      .then((r) => r.data.data),
...
export const odontogramService = {
  forAppointment: (id) =>
    api.get(`/appointments/${id}`).then((r) => r.data.data.odontogram || []),
  updateForAppointment: (id, odontogram) =>
    api
      .put(`/appointments/${id}/odontogram`, { odontogram })
      .then((r) => r.data.data),
  forPatient: (patientId) =>
    api
      .get(`/appointments/patient/${patientId}/odontogram`)
      .then((r) => r.data.data),
};
...
export const paymentService = {
  getDpStatus: (appointmentId) =>
    api
      .get(`/payments/appointment/${appointmentId}/dp`)
      .then((r) => r.data.data),
  createDp: (appointmentId) =>
    api
      .post(`/payments/appointment/${appointmentId}/dp`)
      .then((r) => r.data.data),
  confirmDpDev: (appointmentId) =>
    api
      .post(`/payments/appointment/${appointmentId}/dp/confirm`)
      .then((r) => r.data.data),
};
...
export const dentistLeaveService = {
  list: (params = {}) =>
    api.get("/dentist-leaves", { params }).then((r) => r.data),
  check: (params) =>
    api.get("/dentist-leaves/check", { params }).then((r) => r.data.data),
  create: (data) => api.post("/dentist-leaves", data).then((r) => r.data),
  remove: (id) => api.delete(`/dentist-leaves/${id}`).then((r) => r.data),
};
